...
func main() {
  ...
  _, copyErr := io.Copy(&body, res.Body)
  if copyErr != nil {
    log.Fatal(copyErr)
  }
  var result map[string]interface{}

  jsonErr := json.Unmarshal(body.Bytes(), &result)
  if jsonErr != nil {
    log.Fatal(result)
  }
  ...
  var body_add bytes.Buffer
  _, copyErr = io.Copy(&body_add, res_add.Body)
  if copyErr != nil {
    log.Fatal(copyErr)
  }
  var result_add map[string]interface{}

  jsonerr := json.Unmarshal(body_add.Bytes(), &result_add)
  if jsonerr != nil {
  ...
  _, copyErr = io.Copy(&body1, res1.Body)
  if copyErr != nil {
    log.Fatal(copyErr)
  }
  var result_mapbox map[string]interface{}

  jsonEr := json.Unmarshal(body1.Bytes(), &result_mapbox)
  if jsonEr != nil {
    log.Fatal(result)
  }
  ...
  _, copyErr = io.Copy(&responseBody, resp.Body)
  if copyErr != nil {
    log.Fatal(copyErr)
  }

  var cost map[string]interface{}
  json_err := json.Unmarshal(responseBody.Bytes(), &cost)
  if json_err != nil {
    log.Fatal(result)
  }
